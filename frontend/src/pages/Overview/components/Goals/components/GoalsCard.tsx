...
const STYLE = {
    goalCard: 'min-w-[180px] min-h-[220px] flex flex-1 flex-col justify-between p-4 rounded-4xl shadow-xs border-1 border-black/10 gap-8 transition hover:scale-102 cursor-default duration-600 ease-out bg-white',
