...
const STYLE = {
    goalCard: 'min-w-[180px] min-h-[220px] flex flex-1 flex-col justify-between p-6 rounded-4xl border-1 border-black/10 gap-8 cursor-default duration-600 ease-out bg-white',
