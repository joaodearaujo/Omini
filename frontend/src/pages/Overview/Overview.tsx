...
import { MOCK_GOALS } from "../../MOCK/MOCK_DATA";
import { MOCK_TRANSACTIONS } from "../../MOCK/MOCK_DATA";

const Overview = () => {
  return (
    <div className="grid grid-cols-18 gap-4 flex-1 h-full">
        <div className="col-span-10 flex items-center gap-4 justify-between flex-col flex-1">
            <Card title="Cards">
                <Cards/>
            </Card>
        ...
        <div className="col-span-8 flex flex-col flex-1 justify-between gap-4 ">
