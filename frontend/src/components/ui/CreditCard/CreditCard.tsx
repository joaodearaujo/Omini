        ...
        <div className="w-[360px] h-[220px] rounded-4xl bg-linear-to-r shadow-md from-[#197BBD] to-[#3391D0] flex flex-col items-start justify-around px-6 py-4 transition ease-in-out display-400 hover:scale-101 text-white">
            ...
            <div className="w-full grid grid-cols-4 gap-4">
                <div className="cols-span-2">
                    <p className="text-nowrap text-[10px] opacity-70 uppercase tracking-wider font-medium">Card Holder</p>
                    <p className="text-[14px] font-medium">Name</p>
                </div>
                <div className="cols-span-2">
                    <p className="text-nowrap text-[10px] opacity-70 uppercase tracking-wider font-medium">Expirate Date</p>
                    <p className="text-[14px] font-medium">07/24</p>
                </div>
            </div>
        </div>
  )
