...
const STYLE = {
  container: 'w-full flex-1 max-h-full min-h- flex flex-col items-center justify-start p-6 border-1 border-black/8 rounded-4xl bg-white',
  wrapper: 'w-full h-fit flex flex-col gap-4',
